...
"""
Control Pattern Mapping for UI CrawlingTest Clients.
...
class LegacyIAccessiblePattern():
    ...
    def GetIAccessible(self):
        ...
        Return an IAccessible object that corresponds to the Microsoft UI CrawlingTest element.
...
class ScrollPattern():
    ...
    def SetScrollPercent(self, horizontalPercent: float, verticalPercent: float, waitTime: float = OPERATION_WAIT_TIME) -> bool:
        ...
        Set the horizontal and vertical scroll positions as a percentage of the total content area within the UI CrawlingTest element.
...
class SynchronizedInputPattern():
    ...
    def Cancel(self) -> bool:
        ...
        Cause the Microsoft UI CrawlingTest provider to stop listening for mouse or keyboard input.
        Return bool, True if succeed otherwise False.
    ...
    def StartListening(self) -> bool:
        ...
        Cause the Microsoft UI CrawlingTest provider to start listening for mouse or keyboard input.
        Return bool, True if succeed otherwise False.
...
class TextRange():
    ...
    def GetEnclosingControl(self) -> 'Control':
        ...
        Return `Control` subclass, the innermost UI CrawlingTest element that encloses the text range.
...
class TransformPattern():
    ...
    def Move(self, x: int, y: int, waitTime: float = OPERATION_WAIT_TIME) -> bool:
        ...
        Move the UI CrawlingTest element.
        x: int.
        y: int.
        waitTime: float.
        Return bool, True if succeed otherwise False.
    ...
    def Resize(self, width: int, height: int, waitTime: float = OPERATION_WAIT_TIME) -> bool:
        ...
        Resize the UI CrawlingTest element.
        width: int.
        height: int.
        waitTime: float.
        Return bool, True if succeed otherwise False.
    ...
    def Rotate(self, degrees: int, waitTime: float = OPERATION_WAIT_TIME) -> bool:
        ...
        Rotates the UI CrawlingTest element.
        degrees: int.
        waitTime: float.
        Return bool, True if succeed otherwise False.
...
class VirtualizedItemPattern():
    ...
    def Realize(self, waitTime: float = OPERATION_WAIT_TIME) -> bool:
        ...
        Create a full UI CrawlingTest element for a virtualized item.
        waitTime: float.
        Return bool, True if succeed otherwise False.
